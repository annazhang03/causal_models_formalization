...
Lemma transmitters_in_graph: forall (G: graph) (u v x: node) (l: nodes),
  G_well_formed G = true
  -> is_path_in_graph (u, v, l) G = true
  -> In x (get_transmitters_in_g_path G (u, v, l))
  -> node_in_graph x G = true.
Proof.
  intros G u v x l. intros HG Hp Hx.
  unfold get_transmitters_in_g_path in Hx.
...
Lemma transmitters_in_path: forall (G: graph) (u v x: node) (l: nodes),
  In x (get_transmitters_in_g_path G (u, v, l))
...
Lemma transmitters_induction_add_collider: forall (G: graph) (u h h' v: node) (t': nodes),
  ...
  -> get_transmitters_in_g_path G (u, v, h :: h' :: t') = get_transmitters_in_g_path G (h', v, t').
Proof.
  (* u -> h <- h' ... *)
...
Lemma mediators_in_transmitters: forall (G: graph) (a: node) (u v: node) (l: nodes),
  In a (find_mediators_in_path (u, v, l) G)
  -> In a (get_transmitters_in_g_path G (u, v, l)).
Proof.
  intros G a u v l H.
  unfold get_transmitters_in_g_path. destruct (path_out_of_end (u, v, l) G) as [[|]|] eqn:Hout.
  - destruct (path_into_start (u, v, l) G) as [|] eqn:Hin.
    + right. apply H.
    + apply H.
  - destruct (path_into_start (u, v, l) G) as [|] eqn:Hin.
...
Lemma transmitters_mediators_or_endpoints: forall (G: graph) (a: node) (u v: node) (l: nodes),
  In a (get_transmitters_in_g_path G (u, v, l))
  -> a = u \/ In a (find_mediators_in_path (u, v, l) G) \/ a = v.
Proof.
  intros G a u v l H.
  unfold get_transmitters_in_g_path in H. destruct (path_out_of_end (u, v, l) G) as [[|]|] eqn:Hout.
  - destruct (path_into_start (u, v, l) G) as [|] eqn:Hin.
