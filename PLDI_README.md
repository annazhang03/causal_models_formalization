...
1. System + build
2. Repo structure
3. Paper correspondences
4. Assumptions + admitted lemmas
5. Key content
...
### Paper/Repository Correspondences
<TODO insert table>
...
these are purely auxiliary and not referenced in the semantic development.
